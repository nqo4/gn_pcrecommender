...
WHERE option_name LIKE '%중고%' OR option_name LIKE '%리퍼%' OR option_name LIKE '%전시%' OR option_name LIKE '%해외구매%' OR option_name LIKE '%병행수입%' OR option_name LIKE '%탈거%';
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND name NOT LIKE '%A100%'
  AND name NOT LIKE '%A800%'
  AND name NOT LIKE '%A30%'
  AND name NOT LIKE '%A40%'
  AND name NOT LIKE '%H100%'
  AND name NOT LIKE '%H200%'
  AND name NOT LIKE '%H800%'
  AND name NOT LIKE '%B100%'
  AND name NOT LIKE '%B200%'
  AND name NOT LIKE '%L40%'
  AND name NOT LIKE '%L4 %'
  AND name NOT LIKE '%RTX PRO%'
  AND name NOT LIKE '%Quadro%'
  AND name NOT LIKE '%Tesla%'
  AND name NOT LIKE '%NVL%'
  AND name NOT LIKE '%SXM%'
...
-- RAM 전용: 옵션명 맨 앞 숫자(총 용량 GB)가 64GB 초과인 옵션 제외
-- (묶음 개수가 1개라도 단일 스틱 자체가 대용량인 서버/ECC RAM을 걸러내기 위함)
-- 예) option_name = '64GB_67,526원/1GB' -> 앞의 '64'만 추출해서 비교
DELETE FROM ram_prices_all
WHERE CAST(REGEXP_SUBSTR(option_name, '^[0-9]+') AS UNSIGNED) > 64;
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND name NOT LIKE '%서버용%'
  AND name NOT LIKE '%ECC%'
  AND name NOT LIKE '%레지스터드%'
  AND name NOT LIKE '%RDIMM%'
  AND name NOT LIKE '%LRDIMM%'
  AND name NOT LIKE '%Registered%'
...
SELECT
    ...
    CASE
            ...
            WHEN s.name LIKE '%Seagate%' THEN 'Seagate'
            WHEN s.name LIKE '%씨게이트%' THEN '씨게이트'
            ELSE NULL
        END AS company,
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND (s.name LIKE '%Western Digital%' OR s.name LIKE '%WD %' OR s.name LIKE '%웬디%' OR s.name LIKE '%Seagate%' OR s.name LIKE '%씨게이트%')
  AND EXISTS (
...
SELECT
    ...
    CASE
            ...
            WHEN s.name LIKE '%GIGABYTE%' THEN 'GIGABYTE'
            WHEN s.name LIKE '%기가바이트%' THEN '기가바이트'
            ELSE NULL
        END AS company,
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND name NOT LIKE '%C621%'
  AND name NOT LIKE '%C622%'
  AND name NOT LIKE '%SP3%'
  AND name NOT LIKE '%SP5%'
  AND name NOT LIKE '%서버용%'
  AND name NOT LIKE '%서버보드%'
  AND (s.name LIKE '%MSI%' OR s.name LIKE '%ASUS%' OR s.name LIKE '%에이수스%' OR s.name LIKE '%GIGABYTE%' OR s.name LIKE '%기가바이트%')
  AND EXISTS (
...
SELECT
    ...
    s.name,
    CASE
            WHEN s.name LIKE '%PCCOOLER%' THEN 'PCCOOLER'
            WHEN s.name LIKE '%피씨쿨러%' THEN '피씨쿨러'
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND name NOT LIKE '%리던던트%'
  AND name NOT LIKE '%redundant%'
  AND name NOT LIKE '%Redundant%'
  AND name NOT LIKE '%서버용%'
  AND name NOT LIKE '%CRPS%'
  AND (s.name LIKE '%마이크로닉스%' OR s.name LIKE '%darkFlash%' OR s.name LIKE '%다크플래시%')
  AND EXISTS (
...
WHERE name NOT LIKE '%중고%'
  ...
  AND name NOT LIKE '%병행수입%'
  AND name NOT LIKE '%탈거%'
  AND name NOT LIKE '%랙마운트%'
  AND name NOT LIKE '%서버케이스%'
  AND name NOT LIKE '%랙케이스%'
  AND name NOT LIKE '%19인치 랙%'
