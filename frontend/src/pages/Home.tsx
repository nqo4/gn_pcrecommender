...
import {
  ...
  type GameOption, type UsageProfileOption,
} from "../api";
...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate("/result", { state: { result, selection } });
    } catch {
        ...
        <div className="form-group">
          <div className="budget-input-group">
            <input
              ...
              value={formatBudget(String(budget))}
          ...
          <p className="form-hint">원 단위로 입력해주세요. 화살표를 누르면 10만원 단위로 조정됩니다.</p>
        </div>
      </div>
